<div>
    ...
    @else
        <button wire:click="editComment({{ $commentId }})" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 text-sm rounded-md text-sm transition duration-200">Edit</button>
    @endif
</div>
